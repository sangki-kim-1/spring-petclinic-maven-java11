...
<a href="https://github.com/mbachmann/spring-petclinic-maven-java11">See the presentation here</a>
...
```
$  git clone https://github.com/mbachmann/spring-petclinic-maven-java11
$  cd spring-petclinic
$  ./mvnw package
$  java -jar target/*.jar
```
...
$  docker build -t mbachmannunited/petclinic-mvn-java-11 .

$  docker login
$  docker run -p 8080:8080 -it  mbachmannunited/petclinic-mvn-java-11
$  docker ps
$  docker stop <container>
$  docker rm <container>

$  docker push mbachmannunited/petclinic-mvn-java-11
```
